    ...
    <div class="swiper mySwiper banner-slide">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <img src="{{asset('website/assets/css/images/grocery.webp')}}" class="" alt="">
            </div>
            <div class="swiper-slide">
                <img src="{{asset('website/assets/css/images/grocery.webp')}}" class="" alt="">
            </div>
            ...
            <div class="card-body">
                ...
                <!-- <div class="single-cart-container">
                    ...
                    <div class="cart-product-image mx-4">
                        <img src="{{asset('website/assets/images/products/Apples.')}}webp" alt="">
                    </div>
                    <div>
                ...
                <div class="text-center" style="margin: 50% auto;">
                    <svg width="140" height="176" viewBox="0 0 231.91 292">
                        ...
                        <g id="no_cart_in_bag_2" data-name="no cart in bag 2" transform="translate(-1388 -351)">
                            <ellipse id="Ellipse_2873" data-name="Ellipse 2873" cx="115.955" cy="27.366" rx="115.955"
                                ry="27.366" transform="translate(1388 588.268)" fill="#ddd" opacity="0.25"></ellipse>
